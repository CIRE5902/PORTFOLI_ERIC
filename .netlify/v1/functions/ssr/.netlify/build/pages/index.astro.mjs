import { e as createComponent, f as createAstro, m as maybeRenderHead, h as addAttribute, r as renderTemplate, i as renderHead, j as renderSlot, k as renderComponent } from '../chunks/astro/server_Dgg7pA0k.mjs';
import 'kleur/colors';
import 'html-escaper';
import 'clsx';
/* empty css                                 */
...
const astroLogo = new Proxy({"src":"/_astro/astro.Dm8K3lV8.svg","width":115,"height":48,"format":"svg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/PORTFOLI_ERIC/src/assets/astro.svg";
							}
...
const background = new Proxy({"src":"/_astro/background.BPKAcmfN.svg","width":1440,"height":1024,"format":"svg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/PORTFOLI_ERIC/src/assets/background.svg";
							}
...
}, "/workspaces/PORTFOLI_ERIC/src/components/Welcome.astro", void 0);
...
}, "/workspaces/PORTFOLI_ERIC/src/layouts/Layout.astro", void 0);
